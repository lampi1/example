...
class Service extends Model implements HasMeta
{
    ...
    {
        $this->attributes['ended_at'] = $ended_at ? \Carbon\Carbon::createFromFormat('d/m/Y', $ended_at) : null;
    }

    public function getTranslationsAttribute()
    {
        return Service::where('locale_group','=',$this->locale_group)->where('locale','!=',$this->locale)->get();
    }
    ...
    public function category() {
        return $this->belongsTo('App\Daran\Models\ServiceCategory','service_category_id');
    }
