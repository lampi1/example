...
class FaqCategoryController extends Controller
{
    public function getCategories(Request $request)
    {
        ...
        $qb = FaqCategory::select('id','name','priority')->when($request->filled('lang'),function($q) use($request){
    ...
    public function reorder(Request $request)
    {
        ...
        $faqCategory->priority = $new_index;
        $faqCategory->save();
