...
class PackagingTypeController extends Controller
{
    public function getFamilies(Request $request)
    {
        ...
        $qb = DB::table('packaging_types')
            ...
            ->selectRaw('packaging_types.id,packaging_types.name,packaging_types.priority,COUNT(available_packaging_types.id)+COUNT(base_packaging_type.id) as can_delete')
