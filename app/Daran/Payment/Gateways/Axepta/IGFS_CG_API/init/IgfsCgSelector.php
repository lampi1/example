...
require_once(__DIR__ . "/BaseIgfsCgInit.php");
require_once(__DIR__ . "/SelectorTerminalInfo.php");
...
class IgfsCgSelector extends BaseIgfsCgInit {
	...
	protected function buildRequest() {
		...
		if ($this->shopUserRef != NULL)
			$request = $this->replaceRe__DIR__ . "/uest($request, "{shopUserRef}", "<__DIR__ . "/<![CDATA[" . $this->shopUserRef . "]]></shopUserRef>");
		else
