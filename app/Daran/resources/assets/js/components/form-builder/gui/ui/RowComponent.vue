<template>
    <div class="col-12">
        <div class="col-12 rowItem" v-if="section.isDynamic">
            <div class="tools">
                <p>
                    <span class="add clickable" @click="addDynamicObj"></span>
                </p>
            </div>
            <div class="rowDynamicItem" v-for="(data, index) in section.instances" :key="index" :class="'rowDynamic_' + index">
                <div class="tools">
                    <p>
                        <span class="remove clickable" @click="removeDynamicObj(index)"></span>
                    </p>
                </div>
        ...
        <div class="row rxowItem" v-if="!section.isDynamic" v-for="row in section.rows">
            <control-component v-for="control in row.controls"
                               :key="control.name"
                               :control="control"
                               :label-position="section.labelPosition">
