...
@section('title')
    @lang('daran::news.edit-news-category')
    @parent
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12 mb-3">
            <h3>@lang('daran::news.edit-news-category')</h3>
        </div>
        <div class="col-12 mb-3">
            <form  class="form-template-1" method="post" action="{{ route('admin.news-categories.update', ['news_category' => $category]) }}" enctype="multipart/form-data">
