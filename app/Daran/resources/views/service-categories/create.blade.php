...
@section('title')
    @lang('daran::service.create-service-category')
    @parent
@endsection
...
@section('content')
    <div id="app" class="row">
        <div class="col-12 mb-3">
            <h3>@lang('daran::service.create-service-category')</h3>
        </div>
        <div class="col-12 mb-3">
            <form class="form-template-1" method="post" action="{{ route('admin.service-categories.store') }}" enctype="multipart/form-data">
