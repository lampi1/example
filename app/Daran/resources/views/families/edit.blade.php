...
@section('content')
    <div id="app" class="row">
        ...
        <div class="col-12 mb-3">
            <form id="pageForm" class="form-template-1" method="post" action="{{ route('admin.families.update',['family'=>$family->id]) }}" enctype="multipart/form-data">
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        urldelete = "{{ config('app.url') }}/admin-api/families/";
        var locale = '{{app()->getLocale()}}';

        $('.input--image').on('click', '.delete',function(e){
            var current_id = {{$family->id}};
