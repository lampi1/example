...
@section('title')
    @lang('daran::service.create-services')
    @parent
@endsection
...
@section('content')
    <div id="app" class="row">
        <div class="col-12 mb-3">
            <h3>@lang('daran::service.create-service')</h3>
        </div>
        <div class="col-12 mb-3">
            <form id="newsForm" class="form-template-1" method="post" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        var url_add_category = "{{ config('app.url') }}"+ "/admin-api/services-categories/"
