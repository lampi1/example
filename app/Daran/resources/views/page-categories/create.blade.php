...
@section('title')
    @lang('daran::page.create-page-category')
    @parent
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12 mb-3">
            <h3>@lang('daran::page.create-page-category')</h3>
        </div>
        <div class="col-12 mb-3">
            <form class="form-template-1" method="post" action="{{ route('admin.page-categories.store') }}" enctype="multipart/form-data">
