...
@include('daran::layouts._messages')
    <div class="row">
        <div class="col-12 mb-2 text-right">
            ...
            @can('create item')
                <a href="{{ route('admin.categories.create') }}" class="btn btn-primary">@lang('daran::common.create')</a>
            @endcan
        </div>
        <div class="col-12">
            <hr>
    ...
    <div class="row">
        <div class="col-12 mb-3" id="ref" api-url="">
            <h3>@lang('daran::item.categories')</h3>
        </div>
        <div class="col-12 mb-3" id="app">
            <daran-vuetable ref="vuetable"
                fields-array="ItemCategory"
                api-url="{{route('admin-api.categories.index')}}"
                :paginate="25"
                :route-prefix="'admin.categories'"
                :route-api-prefix="'admin-api.categories'"
                :is-sortable="true"
