...
@section('content')
    <div id="app" class="row">
        <div class="col-12 mb-3">
            <h3>Nuovo Componente Progetto</h3>
        </div>
        <div class="col-12 mb-3">
            <form action="{{ route('admin.projects.store-component') }}" id="blogForm" method="post" class="form-template-1" enctype="multipart/form-data">
