...
<head>
    ...
    @if($brandings)
        <link rel="apple-touch-icon" sizes="180x180" href="{{config('app.url').$brandings->where('lang',app()->getLocale())->first()->favicon_ipad}}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{config('app.url').$brandings->where('lang',app()->getLocale())->first()->favicon_iphone}}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{config('app.url').$brandings->where('lang',app()->getLocale())->first()->favicon}}">
    @endif
    ...
    @section('headerStyles')
        ...
        @if(MetaTag::get('gtag_manager'))
            ...
            })(window,document,'script','dataLayer','{{MetaTag::get('gtag_manager')}}');</script>
        ...
        @elseif(MetaTag::get('g_analytics'))
            ...
            <script>
              ...
              gtag('js', new Date());
              gtag('config', '{{MetaTag::get('g_analytics')}}');
        ...
        @if(MetaTag::get('facebook_pixel'))
            ...
            'https://connect.facebook.net/en_US/fbevents.js');
             fbq('init', '{{MetaTag::get('facebook_pixel')}}');
            fbq('track', 'PageView');
            </script>
            <noscript>
             <img height="1" width="1"
            src="https://www.facebook.com/tr?id={{MetaTag::get('facebook_pixel')}}&ev=PageView
            &noscript=1"/>
            </noscript>
...
<body>
    @if(MetaTag::get('gtag_manager'))
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id={{MetaTag::get('gtag_manager')}}" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
