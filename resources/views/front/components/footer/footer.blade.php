...
<div class="col-lg-4 text-center mt-lg-1 mb-4">
    <div class="d-flex justify-content-center mt-0">
        <a class="footer__link text--sm fc--white"
            href="{{route('pages.view',['permalink'=>trans('routes.permalinks.privacy-policy')])}}">Cookie & Privacy
            policy</a>
    </div>
</div>
<div class="col-lg-4">
    <div class="d-block position-relative w-100">
        ...
        <form id="newsletter-subscribe" class="footer__newsletter-form form-template-1"
            ...
            <div class="w-100">
                ...
                <div class="col-12 px-0 mt-2">
                    <div class="input-checkbox">
                        <input placeholder="@lang('footer.placeholder')" class="input-checkbox__hidden" name="privacy"
                            id="privacy_footer" type="checkbox" value="1" hidden />
...
<footer class="flex bg-primary text-white">
